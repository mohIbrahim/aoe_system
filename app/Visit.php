...
class Visit extends Model
{
    ...
    protected $fillable = ['type', 'visit_date', 'representative_customer_name', 'readings_of_printing_machine', 'comments', 'printing_machine_id', 'follow_up_card_id', 'the_employee_who_made_the_visit_id'];
