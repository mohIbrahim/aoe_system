			...
			$.ajax({
				...
				success: function success(results) {
					...
					$.each(results, function (index, contract) {
						standardTable.row.add([index + 1, "<a href='/contracts/" + contract.id + "'>" + contract.code + "</a>", contract.type, contract.start, contract.end, contract.status, contract.payment_system, contract.printing_machines[0] ? contract.printing_machines[0].customer ? contract.printing_machines[0].customer.name : '' : '']);
					});
					standardTable.draw();
