			...
			$.ajax({
				...
				success: function success(results) {
					...
					$.each(results, function (index, indexation) {
						standardTable.row.add([index + 1, "<a href='/indexations/" + indexation.id + "'>" + indexation.code + "</a>", indexation.printing_machine ? indexation.printing_machine.customer ? indexation.printing_machine.customer ? "<a href='/customers/" + indexation.printing_machine.customer.id + "'>" + indexation.printing_machine.customer.name + "</a>" : '' : '' : indexation.visit ? indexation.visit.printing_machine ? indexation.visit.printing_machine.customer ? "<a href='/customers/" + indexation.visit.printing_machine.customer.id + "'>" + indexation.visit.printing_machine.customer.name + "</a>" : '' : '' : '', indexation.printing_machine ? "<a href='/printing_machines/" + indexation.printing_machine.id + "' targe='_blank'>" + indexation.printing_machine.serial_number + "</a>" : indexation.visit ? indexation.visit.printing_machine ? "<a href='/printing_machines/" + indexation.visit.printing_machine.id + "' targe='_blank'>" + indexation.visit.printing_machine.serial_number + "</a>" : '' : '', indexation.the_date, indexation.customer_approval, indexation.technical_manager_approval, indexation.warehouse_approval, indexation.type, indexation.visit ? indexation.visit.id : '', indexation.visit ? indexation.visit.readings_of_printing_machine : '', indexation.totalPrice]);
					});
					standardTable.draw();
					$("#my-table-body").fadeIn();
				}
