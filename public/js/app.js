			...
			$.ajax({
				...
				success: function success(results) {
					...
					$.each(results, function (index, follow_up_card) {
						standardTable.row.add([index + 1, "<a href='/follow_up_cards/" + follow_up_card.id + "'>" + follow_up_card.code + "</a>", follow_up_card.printing_machine !== null ? follow_up_card.printing_machine.customer !== null ? follow_up_card.printing_machine.customer.name : '' : '', follow_up_card.contract ? "<a href='/contracts/" + follow_up_card.contract.id + "'>" + follow_up_card.contract.code + "</a>" : '', follow_up_card.printing_machine !== null ? follow_up_card.printing_machine.serial_number : '', formatDate(follow_up_card.updated_at) || '']);
					});
					standardTable.draw();
					$("#my-table-body").fadeIn();
				}
