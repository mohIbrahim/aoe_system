			...
			$.ajax({
				...
				success: function success(results) {
					...
					$.each(results, function (index, follow_up_cards) {
						standardTable.row.add([index + 1, "<a href='/follow_up_cards/" + follow_up_cards.id + "'>" + follow_up_cards.code + "</a>", follow_up_cards.contract ? "<a href='/contracts/" + follow_up_cards.contract.id + "'>" + follow_up_cards.contract.code + "</a>" : '']);
					});
					standardTable.draw();
					$("#my-table-body").fadeIn();
				}
