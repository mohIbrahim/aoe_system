@extends('layouts.app')
@section('title')
     تقرير عن الزيارات التي تمت في فترة محددة 
@endsection
@section('content')
	...
	<div class="col-xs-12 col-xs-offset-0 col-sm-12 col-sm-offset-0 col-md-12 col-md-offset-0 col-lg-12 col-lg-offset-0">
		<div class="panel panel-default">
			<div class="panel-heading ">
				<legend> تقرير عن الزيارات التي تمت في فترة محددة  </legend>
				<div class="row">
			...
			<div class="panel-body">
				<div id="visits-in-specific-period-report-loading-message" class="text-center"></div>
				<table class="table table-hover standard-datatable">
					...
					<tbody id="visits-in-specific-period-report-table-body">
					</tbody>
					<tfoot>
						<tr>
                            <th>#</th>
